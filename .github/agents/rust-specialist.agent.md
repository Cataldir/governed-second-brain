...
> **Shared protocol**: See `../instructions/pattern-reasoning.instructions.md` for the mandatory reasoning protocol. Use **Rust examples** or adapt from C++/Java with Rust idioms.

...
- **Canonical output path**: `data/workbench/business/risk-analysis/` (when this path exists in the workspace)
- **Scope boundary**: Business and operational risk — does not replace security scanning tools or Azure compliance audits

## References

- `data/workbench/knowledge/` — Risk management expertise (if available in workspace)

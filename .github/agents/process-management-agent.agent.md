...
- **Canonical output path**: `data/workbench/business/process-optimization/` (when this path exists in the workspace)
...
- `data/workbench/knowledge/` — Operations management expertise (if available in workspace)

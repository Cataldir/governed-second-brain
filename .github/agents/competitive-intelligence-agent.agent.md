...
- **Canonical output path**: `data/workbench/business/competitive-intelligence/` (when this path exists in the workspace)
...
- `data/workbench/knowledge/` — Domain expertise (if available in workspace)

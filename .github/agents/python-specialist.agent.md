...
> **Shared framework**: See `../instructions/paradigm-priority.instructions.md` for the data-oriented > OOP > functional hierarchy.
...
> **Shared protocol**: See `../instructions/pattern-reasoning.instructions.md` for the mandatory reasoning protocol. Use the **Python examples** at <https://refactoring.guru/design-patterns/catalog>.
...
> **Shared techniques**: See `../instructions/refactoring-techniques.instructions.md` for the base technique catalog.
...
> **Shared guidelines**: See `../instructions/architectural-integration.instructions.md` for architecture boundary rules.
...
- [`../instructions/paradigm-priority.instructions.md`](../instructions/paradigm-priority.instructions.md) — Paradigm selection rules
- [`../instructions/pattern-reasoning.instructions.md`](../instructions/pattern-reasoning.instructions.md) — Pattern reasoning

...
> **Shared foundation**: Load and apply `../instructions/azure-infrastructure.instructions.md` for IaC, VNet, zero-downtime, and GitHub workflow standards that apply to all Azure services.
...
> For shared response guidelines (Terraform-first, security, cost, diagnostics), see `../instructions/azure-infrastructure.instructions.md`.

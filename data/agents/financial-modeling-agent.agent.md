...
- **Canonical output path**: `data/workbench/business/financial-models/` (when this path exists in the workspace)
- **Scope boundary**: Business financial modeling only — personal income/royalty tracking belongs to FinanceTracker

## References

- `data/workbench/knowledge/` — Economics and finance expertise (if available in workspace)

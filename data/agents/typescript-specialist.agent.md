...
> **Shared protocol**: See `../instructions/pattern-reasoning.instructions.md` for the mandatory reasoning protocol. Use the **TypeScript examples** at <https://refactoring.guru/design-patterns/catalog>.

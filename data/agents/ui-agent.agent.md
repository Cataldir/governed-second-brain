...
> **Shared protocol**: See `../instructions/pattern-reasoning.instructions.md` for the mandatory reasoning protocol. Use language-specific examples for the target platform (TypeScript for web, Python for CLI, Rust for desktop).
